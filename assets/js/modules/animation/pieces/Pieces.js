...
Pieces.prototype = {
    ...
    initPieces(options) {
        ...
        this.drawList.forEach((img, index) => {
            ...
            const {extraX, extraY} = is.obj(o.extraSpacing) ? o.extraSpacing : {
                extraX: o.extraSpacing,
                extraY: o.extraSpacing
            };
            const {translateX, translateY} = is.fnc(o.translate) ? o.translate() : (is.obj(o.translate) ? o.translate : {
                translateX: o.translate,
                translateY: o.translate
            });
    ...
    clearRect(o) {
        const t = new Transform();
        let newRedraw = false, x, y, w, h, p1, p2, p3, p4, left, top, right, bottom, itemRect, angle, rotate,
            clear     = null;
